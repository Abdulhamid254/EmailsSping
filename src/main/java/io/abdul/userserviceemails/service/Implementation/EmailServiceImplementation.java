...
import static io.abdul.userserviceemails.utils.EmailUtils.getVerificationUrl;
...
//           message.setText(EmailUtils.getEmailMessage(name,host,token));
    ...
    public void sendMimeMessageWithAttachments(String name, String to, String token) {
        try {
            ...
            helper.setPriority(1); // if we don't want it to be sent to the spam folder we give it a high number like 21 showing that it is a critical email
    ...
    public void sendHtmlEmail(String name, String to, String token) {
        try {
            ...
            helper.setFrom(fromEmail);
            helper.setTo(to);
            helper.setText(text, true); // meaning that its html text
    ...
    public void sendHtmlEmailWithEmbeddedFiles(String name, String to, String token) {
        try {
            ...
            DataSource dataSource = new FileDataSource(System.getProperty("user.home") + "/Downloads/server3.png");
    ...
    // helper function for the get contentId
